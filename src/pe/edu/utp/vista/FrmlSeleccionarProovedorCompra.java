 ...
 * @author CHATARA_II
 */
public class FrmlSeleccionarProovedorCompra extends javax.swing.JDialog {
    ...
    public FrmlSeleccionarProovedorCompra(java.awt.Frame parent, FrmlIngreso frml, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        this.setTitle("Seleccion proovedor almacen");
    }
    ...
    private void btnSeleccionarProovedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarProovedorActionPerformed
        ...
        if (tablaListado.getSelectedRowCount()==1) {
            ...
            this.vista.txtIdProovedor.setText(id);
            this.vista.txtNombreProovedor.setText(nombre);
